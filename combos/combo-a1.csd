...
instr $SynthNoteInstrumentNumber
    ...
    k_handRotationVolume = lagud(limit((k_noteRotationVolume - 0.333) * 2, 0, 1), 10, 20) * 2
    k_volume = min((k_handProximityVolume * 0.025) + (expcurve(k_handRotationVolume * 0.333 * k_handProximityVolume , 3)), 1)
