...
/// @internal
opcode _AF_oscillator_component_audio_generator, a, kkiV
...
///
opcode AF_oscillator_component, a, S
    SChannelPrefix xin
    ...
    if (kHost_enabled_1 == {{true}}) then
        ...
        aOut += _AF_oscillator_component_audio_generator(kHost_mix, cpsmidinn(kNoteNumber_1), iHost_wave_1, kHost_pulseWidth_1)
    ...
    if (kHost_enabled_2 == {{true}}) then
        ...
        aOut += _AF_oscillator_component_audio_generator(k(1) - kHost_mix, cpsmidinn(kNoteNumber_2), iHost_wave_2, kHost_pulseWidth_2)
        ; {{LogDebug_k '("kHost_mix = %f", kHost_mix)'}}
...
/// Always-on instrument for the `AF_oscillator_component` opcode.
///
instr AF_oscillator_component
    SChannelPrefix = p4
